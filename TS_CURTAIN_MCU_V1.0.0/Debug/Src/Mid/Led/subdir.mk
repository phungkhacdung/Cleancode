...
Src/Mid/Led/%.o: ../Src/Mid/Led/%.c Src/Mid/Led/subdir.mk
...
clean: clean-Src-2f-Mid-2f-Led

clean-Src-2f-Mid-2f-Led:
	-$(RM) ./Src/Mid/Led/led.d ./Src/Mid/Led/led.o

.PHONY: clean-Src-2f-Mid-2f-Led
